function startExercise(n){if(typeof n=="undefined")mapJsonToExerciseJson(function(n){let t=new ITEM.Exercise(n,{contentWrapSelector:"#assetContentWrapper",exerciseSelector:"#assetContentWrapper .task__list",defaultAreaInstructionDelay:5e3,autoHideAreaErrorInstructionsAfter:5e3,help:!0,assetsPath:"",showIntro:!0,navigation:{selector:"#nav",allowPreviousTask:!0,allowNextTask:!0}});t.Start()},function(n){console.error("Unable to load exercise JSON:",n)});else{let t=new ITEM.Exercise(n,{contentWrapSelector:"#assetContentWrapper",exerciseSelector:"#assetContentWrapper .task__list",defaultAreaInstructionDelay:5e3,autoHideAreaErrorInstructionsAfter:5e3,help:!0,assetsPath:"",showIntro:!0,navigation:{selector:"#nav",allowPreviousTask:!0,allowNextTask:!0}});t.Start()}}function mapJsonToExerciseJson(n,t){var i=$.getJSON({url:"assets/json/umbraco-test.json",success:function(t){let i=JSON.parse(JSON.stringify(t));typeof n=="function"?n(i):console.error("No success callback specified.")},error:function(n){typeof t=="function"?t(n):console.error("No error callback specified.")}})}const ITEM={};ITEM.Exercise=function(n,t){function ve(){i.didStart=!1;i.isFinished=!1;i.isPaused=!1;i.isShowingSettings=!1;i.isShowingResults=!1}function ye(){r("start");t.showIntro||i.didStart?nu():(gr=new Date,i.didStart=!0,d.InitInputController(i.TaskObjectArray[i.currentTaskIndex]),yt())}function pe(){r("init Exercise.js");be(i.jsonData).then(no()).then(th(),we(i.jsonData),de(i.jsonData),ke(i.jsonData),ge(),tu());c()}function we(n){i.exerciseName=n.name}async function be(n){r("initSettings(), {jsonData, settings}:",{jsonData:n,settings:t});typeof n.exerciseSettingsModel!="undefined"&&(t.debugMode=n.exerciseSettingsModel?.exerciseDebugMode);typeof n.exerciseSettingsModel?.exerciseCustomCss!="undefined"&&(t.customCss=n.exerciseSettingsModel.exerciseCustomCss)}function ke(n){vh(n);o.GenerateExerciseHeader(n);o.GenerateExerciseIntroOverlay(n);o.GenerateExerciseMarkup(n)}function de(n){ks(n);gs(n);nh(n)}function ge(){d.InitInputController(i.TaskObjectArray[i.currentTaskIndex]);$(rr).on("click",ts);$(ur).on("click",io);$(ut).on("click",pt);$(ft).on("click",wt);$(fr).on("click",pi);$(ct).on("click",vs);$(et).on("click",is);$(ot).on("click",rs);$(st).on("click",us);$(ht).on("click",fs);$(pu).on("click",es);$(ku).on("click",os);$(du).on("click",bi);$(dt).on("click",function(){wt();$(s).focus()});$(ti).on("click",nr);$(gu).on("click",ns);$(nf).on("click",ps);$(uf).on("click",ko);$(or).on("click",go);$(s).attr("tabindex","0").trigger("focus").on("focusout",oo).on("focus",eo)}function nu(){$(gt).addClass(e);$(gt).find(vu).on("click",hs)}async function no(){v=ITEM.LogController({debugMode:t.debugMode},i.EventLog);d=ITEM.InputController({exerciseContainerSelector:s,dblClickDetect:!0,mouseDownDetect:!0,keyDownDetect:!0,logController:v,debugMode:t.debugMode});y=ITEM.AudioController({onDOMError:cs,debugMode:t.debugMode});h=ITEM.FeedbackController(`${s} ${ii}${f} ${rf}`,{debugMode:t.debugMode,logController:v,exerciseController:this},{feedbackComponentSelector:tf,activeTaskSelector:sr});yi=ITEM.ResultsController(t,i,{});o=ITEM.MarkupController(t,i,{debugMode:t.debugMode});r("init controllers from exercise.js",{logController:v,inputController:d,audioController:y,feedbackController:h,resultController:yi,markupController:o})}function tu(){i.currentTaskIndex=0;i.currentTaskId=i.TaskObjectArray[0][at];i.currentTaskObject=i.TaskObjectArray[0];$(t.exerciseSelector).find(ii).removeClass(lt);$(t.exerciseSelector).find(ff).addClass(lt)}function yt(){!i.isFinished&&i.didStart&&(r("initTask (Exercise.js)",i.TaskObjectArray[i.currentTaskIndex]),$(f).before().find("input")&&$(s).trigger("focus"),d.InitTask(i.TaskObjectArray[i.currentTaskIndex]),su(),ls(),ou(),di(),ru(),to())}function to(){if(!i.isFinished&&i.didStart){r("startTask",i.TaskObjectArray[i.currentTaskIndex]);r("startTask, audioControllerState:",y.GetAudioControllerState());let t=0;t&&t!=""||(t=0);let n=0;n&&n!=""||(n=0);i.TaskObjectArray[i.currentTaskIndex][p].length==0&&i.TaskObjectArray[i.currentTaskIndex][b]==0?n=500:i.TaskObjectArray[i.currentTaskIndex][p].length==0&&i.TaskObjectArray[i.currentTaskIndex][b]!=0&&(n=i.TaskObjectArray[i.currentTaskIndex][b]);let u=window.setTimeout(function(){(typeof n=="undefined"||n)&&ys();ws("proceedTimer",u);tr()},t);lu();hu();gi();i.TaskObjectArray[i.currentTaskIndex][p].length==0&&i.TaskObjectArray[i.currentTaskIndex][b]==0&&(r("startTask (task issues, no interaction && delay)"),setTimeout(w,n));i.TaskObjectArray[i.currentTaskIndex][p].length==0&&i.TaskObjectArray[i.currentTaskIndex][b]>0&&(r("startTask (no interactions, auto-proceed)",n),setTimeout(w,n));c()}}function w(){if(!i.isFinished&&i.didStart){let n={timeSpentOnTask:it};r("OnTaskEnd",n);cu();iu()}}function pt(){if(!i.isFinished&&i.didStart&&!i.isPaused){i.isPaused=!0;ho();as();ir();bt();let n={event:"Pause Task",timeStamp:Date.now(),task:$(s).find(f),explainer:"Paused Task."};v.HandleOutputLogEntry(i.TaskObjectArray[i.currentTaskIndex],n)}r("pauseTask, current EventLog:",i.EventLog);c()}function wt(){if(!i.isFinished&&!i.isShowingSettings&&i.didStart&&i.isPaused){let n=$(t.exerciseSelector).find(f);i.isPaused=!1;r("resumeTask",n);eu();n.find("input").length>0?n.find("input").trigger("focus"):$(s).is(":focus")||$(s).trigger("focus");ou();i.isSubtitled&&di();gi();tr();c();let u={event:"Resume Task",timeStamp:Date.now(),task:$(s).find(f),explainer:"Resumed Task."};v.HandleOutputLogEntry(i.TaskObjectArray[i.currentTaskIndex],u)}}function pi(){if(!i.isFinished&&i.didStart){let n={event:"Skip Task",timeStamp:Date.now(),task:$(s).find(f),explainer:"Brugeren sprang opgavedelen over."};v.HandleOutputLogEntry(i.TaskObjectArray[i.currentTaskIndex],n);cu();iu()}}function io(){if(ki(),!i.isFinished&&i.didStart){let n=$(t.exerciseSelector).find(f);i.currentTaskIndex>-1&&!n.is(":first-of-type")?(i.currentTaskIndex--,t.debugMode&&$(`.${ar}`).text(`Opgave: ${i.currentTaskIndex+1}`),n.find("input:first").val(""),n.removeClass().addClass(hr),n.prev().addClass(lt),yt()):r("First Task - can not go back.")}}function iu(){if(ki(),!i.isFinished&&i.didStart){let n=$(t.exerciseSelector).find(f);i.currentTaskIndex++;r("goToNextTask (start)",n);t.debugMode&&$(`.${ar}`).text(`Opgave: ${i.currentTaskIndex+1}`);i.TaskObjectArray[i.currentTaskIndex]==i.TaskObjectArray[i.TaskObjectArray.length]||n.is(":last-child")?uo():(n.removeClass().addClass(hr),n.next().addClass(lt),i.currentTask=$(t.exerciseSelector).find(f),yt())}}function ru(){r("cleanTask()");$(".show-click-effect").removeClass("show-click-effect");$(".show-keydown-effect").remove();clearTimeout(k);ir();it=0}function uu(){var o,s,u,n,h,e,a,l,t,c;r("autoCompleteTask (start)",i.TaskObjectArray);i.TaskObjectArray[i.currentTaskIndex].userObject.taskDetailObject.autoComplete=!0;let y={event:"Task Auto-Completed.",timeStamp:Date.now(),task:i.TaskObjectArray[i.currentTaskIndex],explainer:"User autocompleted/skipped task."};v.HandleOutputLogEntry(i.TaskObjectArray[i.currentTaskIndex],y,"User autocompleted/skipped task.");for(o of i.TaskObjectArray[i.currentTaskIndex][p])switch(o[si]){case"stringinput":for(n of o[br])if(n.correctInput[0]!=undefined){$(f+" input:first").val("");s=n.correctInput[0];u=0;function t(){u<s.length?($(f+" input:first").val($(f+" input:first").val()+s[u]),u++,setTimeout(t,75)):u===s.length&&(k=setTimeout(w,400))}t()}break;case"click":$(f+" .click:first").addClass("show-click-effect");k=setTimeout(w,1200);break;case"dblclick":$(f+" .dblclick:first").addClass("show-click-effect");k=setTimeout(w,1200);break;case"mouseover":$(f+" .mouseover:first").addClass("show-click-effect");k=setTimeout(w,1200);break;case"rightclick":$(f+" .rightclick:first").addClass("show-click-effect");k=setTimeout(w,1200);break;case"keydown":for(n of o[br])if(n.correctInput!=undefined){t=n.correctInput;h=document.createElement("div");h.classList.add("show-keydown-effect");e=document.createElement("div");e.classList.add("data-key-wrapper");$(f+":first").append(h);$(h).append(e);function i(n){return{up:"🠅",right:"🠆",down:"🠇",left:"🠄",shift:"⇧ shift",meta:"⌘",alt:"⌥ alt",backspace:"⌫ backspace","return":"⏎ enter",capsLock:"caps lock",tab:"↹ tab"}[n]||n}if(t.includes("+")){a=t.split("+");l=[];for(t of a)l.push(`<div class="data-key">${i(t)}</div>`);c=l.join("+");e.innerHTML=c}else c=`<div class="data-key">${i(t)}</div>`,e.innerHTML=c}k=setTimeout(w,600)}}function ro(){r("restartExercise",i);eu();ve();d.ICHandleRestartExercise();h.FCHandleRestartExercise();tu();nu();i.exerciseAttemptCount++}function uo(){i.isFinished=!0;r("handleEndExercise",i);let n={event:"Exercise Complete.",timeStamp:Date.now(),task:i.TaskObjectArray[i.currentTaskIndex],explainer:"User completed the exercise."};v.HandleOutputLogEntry(i.TaskObjectArray[i.TaskObjectArray.length-1],n,"Exercise Complete.");su();ki();bt();ru();fo();ss()}function fo(){let n=yi?.GetExerciseResultObjectArray(i);po();vo();o?.GenerateExerciseResultMarkup(n)}function eo(){r("handleFocus",{showingResults:i.isShowingResults,pause:i.isPaused});wt()}function oo(n){r("handleUnfocus",{isSubtitles:$(n.relatedTarget).is(a),event:n,relatedTarget:n.relatedTarget});$(n.relatedTarget).is($(t.exerciseSelector))&&wi();$(n.relatedTarget).is(yu)&&wi();($(n.relatedTarget).parents(a).length>0||$(n.relatedTarget).is(a))&&wi();i.isShowingResults||$(s).is(".ignore-unfocus")||$(n.relatedTarget).is("input")||pt();$(s).removeClass("ignore-unfocus")}function wi(){$(s).addClass("ignore-unfocus");$(s).trigger("focus")}function so(){$(nt).addClass(e)}function fu(){$(nt).removeClass(e)}function ho(){$(dt).addClass(e);$("body").addClass(lr)}function co(){$("body").removeClass(lr);$(dt).removeClass(e)}function lo(){i.isShowingSettings=!i.isShowingSettings;$(kt).toggleClass(e)}function ao(){return $(wu).toggleClass(e),$(this).toggleClass(ri),!1}function vo(){i.isShowingResults=!0;$(er).toggleClass(e)}function yo(){i.isShowingResults=!1;$(er).removeClass(e)}function po(){$(bu).html("")}function wo(){i.isShowingSettings=!1;$(kt).removeClass(e)}function bo(){$(ni).addClass(e)}function bi(){$(ni).removeClass(e)}function eu(){bi();yo();co();fu();wo()}function ko(){return bt(),!1}function ou(){let t=i.TaskObjectArray[i.currentTaskIndex],n=t.subtitles;r("loadTaskSubtitles",{currentTask:t,subtitles:n});i.isSubtitled&&typeof n!="undefined"&&n!=null&&n!=""&&($(a).addClass(cr),$(a).find("p:first").html(n))}function ki(){r("clearTaskSubtitles");$(a).removeClass(cr);$(a).find("p:first").html("")}function go(){return r("moveTaskSubtitles()",or),$(a).toggleClass("moved"),!1}function ns(){i.isSubtitled=!i.isSubtitled;c()}function di(){return $(a).removeClass(u),!1}function bt(){return $(a).addClass(u),!1}function c(){i.isFinished?($(exerciseSettings).addClass(u),$(ct).addClass(u)):($(exerciseSettings).removeClass(u),$(ct).removeClass(u));i.isPaused?($(ut).addClass(u),$(ft).removeClass(u)):($(ft).addClass(u),$(ut).removeClass(u));i.isMuted?($(et).removeClass(u),$(ot).addClass(u)):($(et).addClass(u),$(ot).removeClass(u));i.isSubtitled?($(st).addClass(u),$(ht).removeClass(u)):($(st).removeClass(u),$(ht).addClass(u))}function ts(){pt();lo()}function is(){return nr(),c(),!1}function rs(){return nr(),c(),!1}function us(){i.isSubtitled=!0;di();c()}function fs(){i.isSubtitled=!1;bt();c()}function es(){$(ni).hasClass(e)?bi():(pt(),bo())}function os(){return r("handleRestartExerciseConfirmBtn",i),ro(),!1}function ss(){$(ur).addClass(l);$(ut).addClass(l);$(ft).addClass(l);$(fr).addClass(l);$(et).addClass(l);$(ot).addClass(l);$(st).addClass(l);$(ht).addClass(l);$(ct).addClass(l);$(rr).addClass(l)}function hs(n){r("handlerBeginExerciseBtn",n);n.preventDefault();gr=new Date;i.didStart=!0;$(gt).removeClass(e);yt()}function cs(n){ir();so();$(nt).find(".error-action:first").html("Tryk her for at prøve igen.");$(nt).find(".error-detail:first").html(n);$(nt).on("click",function(){fu();gi();tr()})}function su(){y?.ClearAudioFile()}function ls(){y?.LoadAudioFile(t.assetsPath+i.TaskObjectArray[i.currentTaskIndex][ei])}function gi(){r("playTaskAudioFile");y?.PlayAudio()}function as(){y?.PauseAudio()}function vs(){r("replayTaskAudioFile (exercise.js)",i);i.isFinished||(y.ReplayAudio(),wt())}function nr(){i.isMuted=!i.isMuted;hu();c()}function hu(){i.isMuted?y?.MuteAudio():y?.UnmuteAudio()}function cu(){let n=i.TaskObjectArray[i.currentTaskIndex];v?.StoreLogEntriesToTask(n)}function ys(){}function ps(){i.hideFeedback=!i.hideFeedback;lu();c()}function lu(){r("handleFeedbackState() ... state.hideFeedback = ",i.hideFeedback);i.hideFeedback?h?.DisableFeedback():h?.EnableFeedback()}function ws(){}function tr(){clearInterval(vi);vi=setInterval(()=>{if(it+=1e3,bs(),t.debugMode){const n=new Date(it),t=String(n.getMinutes()).padStart(2,"0"),i=String(n.getSeconds()).padStart(2,"0");$(`.${lf}`).text("Tid: "+t+":"+i)}},1e3)}function ir(){clearInterval(vi)}function bs(){let n=i.TaskObjectArray[i.currentTaskIndex],t=n[vt];n&&t.length>0&&n.taskFeedback(n.id,"time",{msecsSinceTaskStart:it})}function ks(n){const t=n[fi];r("generateExerciseTaskObject",n);t.forEach((n,t)=>{let r={};r.index=t;r[ei]=n[ei];r[vr]=n[vr];r[yr]=n[yr];r[at]=n[at];r[p]=n[p];r[vt]=n[vt];r[b]=n[b];r.callback=w;r.taskFeedback=h?.ShowTaskFeedback;r.interactionFeedbackList=[h?.ShowInteractionFeedback];r.userObject={taskLog:[],taskDetailObject:{}};i.TaskObjectArray.push(r)})}function ds(n){return n=au(n),{left:n.x,top:n.y,width:n.width,height:n.height}}function gs(n){const t=n[fi];t.forEach(n=>{let r=n[p],t={};r.forEach(n=>{t[oi]=n[oi],t[pr]=n[pr],t[si]=n[si],t[wr]=n[wr],t.onCompleteId=n.onCompleteId,t.callback=h?.ShowInteractionFeedback});i.InteractionArray.push(t)})}function nh(n){const t=n[fi];t.forEach(n=>{let u=n[at],t=n[p],i=n[vt];i&&h&&i.forEach(n=>{let l=n[re],a=n[li],v=n[li][ue],y=n[li][fe],p=n[dr],f=n[dr][ee],w=n[ai],b=n[ai][oe],k=n[ai][se],d=n[g],e=n[g][he],nt=n[g][ce],o=n[g][le],s=n[g][ae],c=n[g].callback;var i=new ITEM.FeedbackController.FeedbackItem(l);if(w?i.SetStyleType(b,k):i.SetStyleType(undefined,undefined),i.SetType("task",u),a?i.SetDisplay(v,y):i.SetDisplay("time",2e4),p&&f.length>0)i.SetInteractionHighlight(f);else{const n=[];t.forEach(t=>{const i=t.id;n.push(i)});i.SetInteractionHighlight(n)}d?nt==!0?i.SetDismiss(o,s,e,uu,c):i.SetDismiss(o,s,e,undefined,c):i.SetDismiss("auto","8000",undefined,!1,undefined);r("_feedbackArray - adding taskfeedback item:",i);h.AddFeedbackToArray(i)});t&&h&&t.forEach(n=>{let i=n[oi],t=n[af];r("interactionFeedbackList",t);t&&t.forEach(n=>{let u=n[vf],l=n[yf],a=n[ci],v=n[ci][kf],y=n[ci][df],p=n[hi],w=n[hi][pf],b=n[hi][wf],f=n[kr],k=n[kr][bf],d=n[tt],g=n[tt][ne],e=n[tt][te],o=n[tt][ie],s=n[tt][gf],c=n.dismiss.callback;var t=new ITEM.FeedbackController.FeedbackItem(l);u&&(t.id=u);a?t.SetStyleType(v,y):t.SetStyleType(undefined,undefined);t.SetType("interaction",i);p?t.SetDisplay(w,b):t.SetDisplay(undefined,undefined);f&&f.length>0?t.SetInteractionHighlight(k):t.SetInteractionHighlightAsArray(i);d?g==!0?t.SetDismiss(e,o,s,uu,c):t.SetDismiss(e,o,s,undefined,c):t.SetDismiss("auto","8000",undefined,!1,undefined);r("_feedbackArray - adding interaction item:",t);h.AddFeedbackToArray(t)})})})}function th(){t.debugMode&&(r("initDebug",i),rh(),uh(),ih())}function ih(){$("#debug--finish-exercise").on("click",lh)}function rh(){if(o){r("initDebugDisplays");let n=o.GetDebugMsgInput(fh,eh),t=o.GetDebugTaskTimer("00:00"),i=o.GetDebugTaskCount();$(ui).append(t);$(ui).append(i);$(ui).append(n)}}function uh(){if(o){let n=o?.GetHeaderBtn("bug_report",ao,{tooltip:"Debug Menu"}),t=o?.GetHeaderBtn("local_fire_department",ch,{tooltip:"Debug Sight"}),i=o?.GetHeaderBtn("image_aspect_ratio",hh,{tooltip:"Make Interaction Rectangles"}),r=o?.GetHeaderBtn("skip_next",pi,{tooltip:"Skip Task"});$(rt).append(t);$(rt).append(n);$(rt).append(i);$(rt).append(r)}}function fh(n){if($(n.target).val().length>0){let t=$(n.target).val();navigator.clipboard.writeText(t);r("copied to clipboard:",{copyValue:t});$(n.target).next().text(` --copied!`)}}function eh(n){oh(n)}function oh(n){let i=$(`${sr} .${hf}`),u=$(n.target).val(),f=u.replace(/(['"])?([a-z0-9A-Z_]+)(['"])?:/g,'"$2": '),r={};try{r=JSON.parse(f)}catch(e){sh(e,n)}let t=ds(r);t=au(t);i.length>0&&i.css(t)}function sh(n){$(`#${cf} span`).text("Input JSON error.");r("JSON input error: ",{error:n})}function hh(){return $("body").toggleClass(sf),$(this).toggleClass(ri),i.isGeneratingRectanglesMode=!i.isGeneratingRectanglesMode,c(),d?.ToggleReportRectangle(i.isGeneratingRectanglesMode,null),!1}function ch(){return $("body").toggleClass(ef),$(this).toggleClass(ri),!1}function lh(){i.didStart=!0;let n=Array.from($(ii));for(let t=0;t<n.length;t++)pi()}function r(n,i){t.debugMode&&console.log(n,i)}function ah(){return i.TaskObjectArray[i.currentTaskIndex]}function au(n){let t=n;return Object.keys(t).forEach(n=>{typeof t[n]=="number"&&(t[n]=t[n]+"%")}),t}function vh(){let n=t.customCss;if(r("handleExerciseCustomCss, string",{customCssString:n,json:json,settings:t}),typeof n!="undefined"){let r=document.createElement("style");r.type="text/css";r.innerHTML=n;$(t.contentWrapSelector).append(r);i.customCssSheet=r}}r("jsonData:",typeof n);const vu="#intro-begin",rt=".exercise-header__tools-list",yu=".task-tool",rr="#exerciseSettings",ur="#prevTask",ut="#pauseTask",ft="#playTask",et="#enableAudio",ot="#disableAudio",fr="#skipTask",st="#enableSubtitles",ht="#disableSubtitles",ct="#replayAudio",pu="#restartExercise",l="hidden",wu="#debug-overlay",kt="#settings-overlay",er="#results-overlay",dt="#unfocus-overlay",nt="#audio-error-overlay",gt="#intro-overlay",bu="#result-attempt-list",ni="#confirm-restart-overlay",ku="#confirm-restart-btn",du="#cancel-restart-btn",ti="#mute-checkbox",gu="#subtitles-checkbox-settings",nf="#feedback-checkbox",tf="feedback-component",rf=".feedback-wrapper",a="#subtitles",uf="#subtitles-hide",or="#subtitles-move",ii=".task",ff=".task:first",sr=".task.active:first",f=".active",s=t.exerciseSelector,yh=t.navigation.selector,hr="task",u="hidden",e="active-overlay",cr="active-subtitles",lt="active",lr="paused",ri="active",ui="#exercise-debug-container",ef="debug-sight",sf="debug-record-rect",hf="mock-interaction",cf="debug-msg",lf="debug__task-timer",ar="debug__task-count",fi="exerciseTaskModels",at="id",ei="audioFile",b="delay",vr="screenshot",yr="subtitles",p="interactionList",vt="feedbackList",oi="id",pr="name",si="type",af="feedbackList",wr="dimensions",br="assessmentList",vf="id",yf="text",hi="display",pf="type",wf="threshold",kr="highlight",bf="highlightInteraction",ci="feedbackType",kf="mood",df="size",tt="dismiss",gf="text",ne="doItForMe",te="type",ie="timeout",re="text",li="display",ue="type",fe="threshold",dr="highlight",ee="highlightInteraction",ai="feedbackType",oe="mood",se="size",g="dismiss",he="text",ce="doItForMe",le="type",ae="timeout";let gr=null,it=0,vi,k;var v,d,y,h,yi,o,i={jsonData:n,currentTaskObject:{},currentTaskId:new String,currentTaskIndex:0,exerciseAttemptCount:0,InteractionArray:[],TaskObjectArray:[],EventLog:[],didStart:!1,isFinished:!1,isPaused:!1,isShowingSettings:!1,isShowingResults:!1,hideFeedback:!1,isMuted:!1,isSubtitled:!0,isGeneratingRectanglesMode:!1};return this.Start=ye,this.GetCurrentTaskObject=ah,pe(),this};ITEM.AudioController=function(n){function t(t,i){n.debugMode&&console.log(t,i)}function i(){if(u()){t("PlayAudio (fileCheck FAILED)",audioControllerState);let r=audioControllerState.playAttemptCount,n=audioControllerState.audioObject.play();t("playAudio (start)",{audioObject:audioControllerState.audioObject,audioFile:audioControllerState.currentFile,attempts:r,promist:n});typeof n!="undefined"&&audioControllerState.currentFile!=""&&n.then(()=>{audioControllerState.playAttemptCount=0}).catch(u=>(audioControllerState.playAttemptCount<1?setTimeout(function(){t(`playAudio() : attempting to play audio at attempt #${r+1} `,n);i()},250):(t(`playAudio() : Could not play audiofile after ${r+1} attempts. Handling error:`,u),h(u)),audioControllerState.playAttemptCount>1?(f(),!1):void 0));audioControllerState.playAttemptCount++}}function e(){t("pauseAudio (audioPlayer.js)");audioControllerState.audioObject.pause()}function o(){t("replayAudio (audioPlayer.js)");audioControllerState.audioObject.currentTime=0;audioControllerState.audioObject.play()}function r(){t("stopAudio (audioPlayer.js)");audioControllerState.audioObject.currentTime=0;audioControllerState.audioObject.pause()}function s(n,i,r){audioControllerState.formerFile=audioControllerState.currentFile;audioControllerState.currentFile=n;audioControllerState.audioObject=new Audio(audioControllerState.currentFile);t("loadAudioFile",{audioObj:audioControllerState.audioObject,file:n,callback:i,duration:audioControllerState.audioObject.duration});audioControllerState.audioObject.addEventListener("play",function(){audioControllerState.isPlaying=!0;audioControllerState.isPaused=!1;r=="play"&&i()});audioControllerState.audioObject.addEventListener("pause",function(){audioControllerState.isPaused=!0;r=="pause"&&i()});audioControllerState.audioObject.addEventListener("ended",function(){audioControllerState.isPlaying=!1;audioControllerState.isPaused=!1;(r=="ended"||typeof r==undefined)&&i()})}function u(){return audioControllerState.currentFile!=""?!0:!1}function h(i){t("handleError (audio). Error:",{error:i,state:audioControllerState});switch(i.constructor){case DOMException:if(n.onDOMError!==undefined)n.onDOMError("Du skal lige interagere med din browser før vi må afspille lyden ...");else console.error(i);break;case SyntaxError:if(n.onDOMError!==undefined)n.onDOMError("Der er noget galt med lydfilen. Kontakt en kursusadminstrator.");else console.error(i);break;case Error:if(n.onDOMError!==undefined)n.onDOMError("Der er noget galt med lydfilen. Kontakt en kursusadminstrator.");else console.error(i);break;default:if(n.onDOMError!==undefined)n.onDOMError("Der er noget galt med lydfilen. Kontakt en kursusadminstrator.");else console.error(i)}}function f(){r();audioControllerState.formerFile=audioControllerState.currentFile;audioControllerState.currentFile="";audioControllerState.audioObject=new Audio(audioControllerState.currentFile)}function c(){audioControllerState.audioObject.volume=0}function l(){audioControllerState.audioObject.volume=1}function a(){return audioControllerState}function v(){return audioControllerState.audioObject}function y(){return typeof audioControllerState.audioObject!="undefined"&&audioControllerState.audioObject!=null?audioControllerState.audioObject.src==""?audioControllerState.audioObject.duration:!1:!1}return audioControllerState={audioObject:new Audio,isPlaying:!1,isPaused:!1,currentFile:"",formerFile:"",playAttemptCount:0},this.PlayAudio=i,this.ReplayAudio=o,this.StopAudio=r,this.PauseAudio=e,this.FileCheck=u,this.LoadAudioFile=s,this.ClearAudioFile=f,this.MuteAudio=c,this.UnmuteAudio=l,this.GetAudioFileDuration=y,this.GetAudioObject=v,this.GetAudioControllerState=a,this};ITEM.MarkupController=function(n,t){function ft(){}function et(t){const i=t[d],r=$(n.exerciseSelector);i.forEach(t=>{let i=[],u=t[tt],f=n.assetsPath+t[g],e=t[nt];i.push(`
                <div class="${h}" id="${u}">
                <div class="${c}"></div>
