function startExercise(n){if(typeof n=="undefined")mapJsonToExerciseJson(function(n){let t=new ITEM.Exercise(n,{contentWrapSelector:"#assetContentWrapper",exerciseSelector:"#assetContentWrapper .task__list",defaultAreaInstructionDelay:5e3,autoHideAreaErrorInstructionsAfter:5e3,help:!0,assetsPath:"",showIntro:!0,navigation:{selector:"#nav",allowPreviousTask:!0,allowNextTask:!0}});t.Start()},function(n){console.error("Unable to load exercise JSON:",n)});else{let t=new ITEM.Exercise(n,{contentWrapSelector:"#assetContentWrapper",exerciseSelector:"#assetContentWrapper .task__list",defaultAreaInstructionDelay:5e3,autoHideAreaErrorInstructionsAfter:5e3,help:!0,assetsPath:"",showIntro:!0,navigation:{selector:"#nav",allowPreviousTask:!0,allowNextTask:!0}});t.Start()}}function mapJsonToExerciseJson(n,t){var i=$.getJSON({url:"assets/json/umbraco-test.json",success:function(t){let i=JSON.parse(JSON.stringify(t));typeof n=="function"?n(i):console.error("No success callback specified.")},error:function(n){typeof t=="function"?t(n):console.error("No error callback specified.")}})}const ITEM={};ITEM.Exercise=function(n,t){function be(){i.didStart=!1;i.isFinished=!1;i.isPaused=!1;i.isShowingSettings=!1;i.isShowingResults=!1}function ke(){r("start");t.showIntro||i.didStart?ru():(_startDate=new Date,i.didStart=!0,w?.InitInputController(i.TaskObjectArray[i.currentTaskIndex]),vt())}function de(){r("init Exercise.js");no().then(uo()).then(ge()).then(io()).then(to()).then(ro()).then(uu(),eh());c()}function ge(n=i.jsonData){i.exerciseName=n.name}async function no(n=i.jsonData){r("initSettings(), {jsonData, settings}:",{jsonData:n,settings:t});typeof n.exerciseSettingsModel!="undefined"&&(t.debugMode=n.exerciseSettingsModel?.exerciseDebugMode);typeof n.exerciseSettingsModel?.exerciseCustomCss!="undefined"&&(t.customCss=n.exerciseSettingsModel.exerciseCustomCss)}function to(n=i.jsonData){nc(n);o.GenerateExerciseHeader(n);o.GenerateExerciseIntroOverlay(n);o.GenerateExerciseMarkup(n)}function io(n=i.jsonData){ih(n);uh(n);fh(n)}function ro(){let n=i.TaskObjectArray[i.currentTaskIndex];if(n&&n!==void 0){w?.InitInputController(n);$(or).on("click",es);$(sr).on("click",oo);$(rt).on("click",yt);$(ut).on("click",pt);$(hr).on("click",ki);$(ht).on("click",ks);$(ft).on("click",os);$(et).on("click",ss);$(ot).on("click",hs);$(st).on("click",cs);$(du).on("click",ls);$(tf).on("click",as);$(rf).on("click",gi);$(dt).on("click",function(){pt();$(s).focus()});$(ti).on("click",rr);$(ii).on("click",fs);$(ri).on("click",gs);$(hf).on("click",rs);$(lr).on("click",us);$(s).attr("tabindex","0").trigger("focus").on("focusout",ao).on("focus",lo)}else er()}function ru(){$(gt).addClass(e);$(gt).find(bu).on("click",ys)}async function uo(){v=ITEM.LogController({debugMode:t.debugMode},i.EventLog);w=ITEM.InputController({exerciseContainerSelector:s,dblClickDetect:!0,mouseDownDetect:!0,keyDownDetect:!0,logController:v,debugMode:t.debugMode});y=ITEM.AudioController({onDOMError:ps,debugMode:t.debugMode});h=ITEM.FeedbackController(`${s} ${ui}${f} ${sf}`,{debugMode:t.debugMode,logController:v,exerciseController:this},{feedbackComponentSelector:ef,activeTaskSelector:ar});bi=ITEM.ResultsController(t,i,{});o=ITEM.MarkupController(t,i,{debugMode:t.debugMode});r("init controllers from exercise.js",{logController:v,inputController:w,audioController:y,feedbackController:h,resultController:bi,markupController:o})}function uu(){i.currentTaskIndex=0;typeof i.TaskObjectArray[0]!="undefined"&&i.TaskObjectArray[0]?(i.currentTaskId=i.TaskObjectArray[0][lt],i.currentTaskObject=i.TaskObjectArray[0]):fu();$(t.exerciseSelector).find(ui).removeClass(ct);$(t.exerciseSelector).find(cf).addClass(ct)}function vt(){let n=i.TaskObjectArray[i.currentTaskIndex];n!==void 0&&n?!i.isFinished&&i.didStart&&w&&(r("initTask (Exercise.js)",i.TaskObjectArray[i.currentTaskIndex]),$(f).before().find("input")&&$(s).trigger("focus"),w.InitTask(n),au(),ws(),lu(),tr(),ou(),fo()):fu()}function fu(){let n={currentState:i,errorLocation:"inittask",errortype:"Object"};er(n)}function fo(){let n=i.TaskObjectArray[i.currentTaskIndex];if(n!==void 0&&n){if(!i.isFinished&&i.didStart){r("startTask",n);let u=typeof n!="undefined"?n[k]:[],i=typeof n!="undefined"?n[hi]:0,f=0;f&&f!=""||(f=0);let t=0;t&&t!=""||(t=0);u.length==0&&i==0?t=500:u.length==0&&i!=0&&(t=i);let e=window.setTimeout(function(){(typeof t=="undefined"||t)&&ds();nh("proceedTimer",e);ur()},f);pu();vu();ir();u.length==0&&i==0&&(r("startTask (task issues, no interaction && delay)"),setTimeout(p,t));u.length==0&&i>0&&(r("startTask (no interactions, auto-proceed)",t),setTimeout(p,t))}}else eo();c()}function eo(){let n={currentState:i,errorLocation:"starttask",errortype:"Object"};er(n)}function p(){if(!i.isFinished&&i.didStart){let n={timeSpentOnTask:tt};r("OnTaskEnd",n);yu();eu()}}function yt(){if(!i.isFinished&&i.didStart&&!i.isPaused){i.isPaused=!0;yo();bs();fr();wt();let n={event:"Pause Task",timeStamp:Date.now(),task:$(s).find(f),explainer:"Paused Task."};v.HandleOutputLogEntry(i.TaskObjectArray[i.currentTaskIndex],n)}r("pauseTask, current EventLog:",i.EventLog);c()}function pt(){if(!i.isFinished&&!i.isShowingSettings&&i.didStart&&i.isPaused){let n=$(t.exerciseSelector).find(f);i.isPaused=!1;r("resumeTask",n);cu();n.find("input").length>0?n.find("input").trigger("focus"):$(s).is(":focus")||$(s).trigger("focus");lu();i.isSubtitled&&tr();ir();ur();c();let u={event:"Resume Task",timeStamp:Date.now(),task:$(s).find(f),explainer:"Resumed Task."};v.HandleOutputLogEntry(i.TaskObjectArray[i.currentTaskIndex],u)}}function ki(){if(!i.isFinished&&i.didStart){let n={event:"Skip Task",timeStamp:Date.now(),task:$(s).find(f),explainer:"Brugeren sprang opgavedelen over."};v.HandleOutputLogEntry(i.TaskObjectArray[i.currentTaskIndex],n);yu();eu()}}function oo(){if(nr(),!i.isFinished&&i.didStart){let n=$(t.exerciseSelector).find(f);i.currentTaskIndex>-1&&!n.is(":first-of-type")?(i.currentTaskIndex--,t.debugMode&&$(`.${wr}`).text(`Opgave: ${i.currentTaskIndex+1}`),n.find("input:first").val(""),n.removeClass().addClass(vr),n.prev().addClass(ct),vt()):r("First Task - can not go back.")}}function eu(){let n=$(t.exerciseSelector).find(f),u=i.TaskObjectArray[i.currentTaskIndex];nr();!i.isFinished&&i.didStart&&(i.currentTaskIndex++,r("goToNextTask (start)",n),t.debugMode&&$(`.${wr}`).text(`Opgave: ${i.currentTaskIndex+1}`),u==i.TaskObjectArray[i.TaskObjectArray.length]||n.is(":last-child")?ho():(n.removeClass().addClass(vr),n.next().addClass(ct),i.currentTask=$(t.exerciseSelector).find(f),vt()))}function ou(){r("cleanTask()");$(".show-click-effect").removeClass("show-click-effect");$(".show-keydown-effect").remove();clearTimeout(b);fr();tt=0}function su(){var o,s,u,n,h,e,a,l,t,c;r("autoCompleteTask (start)",i.TaskObjectArray);i.TaskObjectArray[i.currentTaskIndex].userObject.taskDetailObject.autoComplete=!0;let y={event:"Task Auto-Completed.",timeStamp:Date.now(),task:i.TaskObjectArray[i.currentTaskIndex],explainer:"User autocompleted/skipped task."};v.HandleOutputLogEntry(i.TaskObjectArray[i.currentTaskIndex],y,"User autocompleted/skipped task.");for(o of i.TaskObjectArray[i.currentTaskIndex][k])switch(o[li]){case"stringinput":for(n of o[nu])if(n.correctInput[0]!=undefined){$(f+" input:first").val("");s=n.correctInput[0];u=0;function t(){u<s.length?($(f+" input:first").val($(f+" input:first").val()+s[u]),u++,setTimeout(t,75)):u===s.length&&(b=setTimeout(p,400))}t()}break;case"click":$(f+" .click:first").addClass("show-click-effect");b=setTimeout(p,1200);break;case"dblclick":$(f+" .dblclick:first").addClass("show-click-effect");b=setTimeout(p,1200);break;case"mouseover":$(f+" .mouseover:first").addClass("show-click-effect");b=setTimeout(p,1200);break;case"rightclick":$(f+" .rightclick:first").addClass("show-click-effect");b=setTimeout(p,1200);break;case"keydown":for(n of o[nu])if(n.correctInput!=undefined){t=n.correctInput;h=document.createElement("div");h.classList.add("show-keydown-effect");e=document.createElement("div");e.classList.add("data-key-wrapper");$(f+":first").append(h);$(h).append(e);function i(n){return{up:"🠅",right:"🠆",down:"🠇",left:"🠄",shift:"⇧ shift",meta:"⌘",alt:"⌥ alt",backspace:"⌫ backspace","return":"⏎ enter",capsLock:"caps lock",tab:"↹ tab"}[n]||n}if(t.includes("+")){a=t.split("+");l=[];for(t of a)l.push(`<div class="data-key">${i(t)}</div>`);c=l.join("+");e.innerHTML=c}else c=`<div class="data-key">${i(t)}</div>`,e.innerHTML=c}b=setTimeout(p,600)}}function so(){r("restartExercise",i);cu();be();w.ICHandleRestartExercise();h.FCHandleRestartExercise();uu();ru();i.exerciseAttemptCount++}function ho(){i.isFinished=!0;r("handleEndExercise",i);let n={event:"Exercise Complete.",timeStamp:Date.now(),task:i.TaskObjectArray[i.currentTaskIndex],explainer:"User completed the exercise."};v.HandleOutputLogEntry(i.TaskObjectArray[i.TaskObjectArray.length-1],n,"Exercise Complete.");au();nr();wt();ou();co();vs()}function co(){let n=bi?.GetExerciseResultObjectArray(i);ns();ko();o?.GenerateExerciseResultMarkup(n)}function lo(){r("handleFocus",{showingResults:i.isShowingResults,pause:i.isPaused});pt()}function ao(n){r("handleUnfocus",{isSubtitles:$(n.relatedTarget).is(a),event:n,relatedTarget:n.relatedTarget});$(n.relatedTarget).is($(t.exerciseSelector))&&di();$(n.relatedTarget).is(ku)&&di();($(n.relatedTarget).parents(a).length>0||$(n.relatedTarget).is(a))&&di();i.isShowingResults||$(s).is(".ignore-unfocus")||$(n.relatedTarget).is("input")||yt();$(s).removeClass("ignore-unfocus")}function di(){$(s).addClass("ignore-unfocus");$(s).trigger("focus")}function vo(){$(g).addClass(e)}function hu(){$(g).removeClass(e)}function yo(){$(dt).addClass(e);$("body").addClass(pr)}function po(){$("body").removeClass(pr);$(dt).removeClass(e)}function wo(){i.isShowingSettings=!i.isShowingSettings;$(kt).toggleClass(e)}function bo(){return $(gu).toggleClass(e),$(this).toggleClass(fi),!1}function ko(){i.isShowingResults=!0;$(cr).toggleClass(e)}function go(){i.isShowingResults=!1;$(cr).removeClass(e)}function ns(){$(nf).html("")}function ts(){i.isShowingSettings=!1;$(kt).removeClass(e)}function is(){$(ni).addClass(e)}function gi(){$(ni).removeClass(e)}function cu(){gi();go();po();hu();ts()}function rs(){return wt(),!1}function lu(){let t=i.TaskObjectArray[i.currentTaskIndex],n=t?.subtitles;r("loadTaskSubtitles",{currentTask:t,subtitles:n});i.isSubtitled&&typeof n!="undefined"&&n!=null&&n!=""&&($(a).addClass(yr),$(a).find("p:first").html(n))}function nr(){r("clearTaskSubtitles");$(a).removeClass(yr);$(a).find("p:first").html("")}function us(){return r("moveTaskSubtitles()",lr),$(a).toggleClass("moved"),!1}function fs(){i.isSubtitled=!i.isSubtitled;c()}function tr(){return $(a).removeClass(u),!1}function wt(){return $(a).addClass(u),!1}function c(){i.isFinished?($(exerciseSettings).addClass(u),$(ht).addClass(u)):($(exerciseSettings).removeClass(u),$(ht).removeClass(u));i.isPaused?($(rt).addClass(u),$(ut).removeClass(u)):($(ut).addClass(u),$(rt).removeClass(u));i.isMuted?($(ft).addClass(u),$(et).removeClass(u)):($(ft).removeClass(u),$(et).addClass(u));i.isSubtitled?($(ot).addClass(u),$(st).removeClass(u)):($(ot).removeClass(u),$(st).addClass(u))}function bt(){i.hideFeedback?$(ri).prop("checked",!1):$(ri).prop("checked",!0);i.isMuted?$(ti).prop("checked",!1):$(ti).prop("checked",!0);i.isSubtitled?$(ii).prop("checked",!0):$(ii).prop("checked",!1)}function es(){yt();wo()}function os(){return rr(),c(),bt(),!1}function ss(){return rr(),c(),bt(),!1}function hs(){console.log("hest",i.isSubtitled);i.isSubtitled=!0;tr();c();bt();console.log("hest",i.isSubtitled)}function cs(){i.isSubtitled=!1;wt();c();bt()}function ls(){$(ni).hasClass(e)?gi():(yt(),is())}function as(){return r("handleRestartExerciseConfirmBtn",i),so(),!1}function vs(){$(sr).addClass(l);$(rt).addClass(l);$(ut).addClass(l);$(hr).addClass(l);$(ft).addClass(l);$(et).addClass(l);$(ot).addClass(l);$(st).addClass(l);$(ht).addClass(l);$(or).addClass(l)}function ys(n){r("handlerBeginExerciseBtn",n);n.preventDefault();_startDate=new Date;i.didStart=!0;$(gt).removeClass(e);vt()}function ps(n){fr();vo();$(g).find(".error-action:first").html("Tryk her for at prøve igen.");$(g).find(".error-detail:first").html(n);$(g).on("click",function(){hu();ir();ur()})}function au(){y?.ClearAudioFile()}function ws(){let n=typeof i.TaskObjectArray[i.currentTaskIndex]!="undefined"?i.TaskObjectArray[i.currentTaskIndex]:null,r=n!=null?n[si]:"";y?.LoadAudioFile(t.assetsPath+r)}function ir(){r("playTaskAudioFile");y?.PlayAudio()}function bs(){y?.PauseAudio()}function ks(){r("replayTaskAudioFile (exercise.js)",i);i.isFinished||(y.ReplayAudio(),pt())}function rr(){i.isMuted=!i.isMuted;vu();c()}function vu(){i.isMuted?y?.MuteAudio():y?.UnmuteAudio()}function yu(){let n=i.TaskObjectArray[i.currentTaskIndex];v?.StoreLogEntriesToTaskObject(n)}function ds(){}function gs(){i.hideFeedback=!i.hideFeedback;pu();c()}function pu(){r("handleFeedbackState() ... state.hideFeedback = ",i.hideFeedback);i.hideFeedback?h?.DisableFeedback():h?.EnableFeedback()}function nh(){}function ur(){clearInterval(wi);wi=setInterval(()=>{if(tt+=1e3,th(),t.debugMode){const n=new Date(tt),t=String(n.getMinutes()).padStart(2,"0"),i=String(n.getSeconds()).padStart(2,"0");$(`.${pf}`).text("Tid: "+t+":"+i)}},1e3)}function fr(){clearInterval(wi)}function th(){let n=i.TaskObjectArray[i.currentTaskIndex],t=n[at];n&&typeof n.taskFeedback!="undefined"&&t.length>0&&n.taskFeedback(n.id,"time",{msecsSinceTaskStart:tt})}function ih(n){const t=n[oi];r("generateExerciseTaskObject",n);t.forEach((n,t)=>{let r={};r.index=t;r[si]=n[si];r[br]=n[br];r[kr]=n[kr];r[lt]=n[lt];r[k]=n[k];r[at]=n[at];r[hi]=n[hi];r.callback=p;r.taskFeedback=h?.ShowTaskFeedback;r.interactionFeedbackList=[h?.ShowInteractionFeedback];r.userObject={taskLog:[],taskDetailObject:{}};i.TaskObjectArray.push(r)})}function rh(n){return n=wu(n),{left:n.x,top:n.y,width:n.width,height:n.height}}function uh(n){const t=n[oi];t.forEach(n=>{let r=n[k],t={};r.forEach(n=>{t[ci]=n[ci],t[dr]=n[dr],t[li]=n[li],t[gr]=n[gr],t.onCompleteId=n.onCompleteId,t.callback=h?.ShowInteractionFeedback});i.InteractionArray.push(t)})}function fh(n){const t=n[oi];t.forEach(n=>{let u=n[lt],t=n[k],i=n[at];i&&h&&i.forEach(n=>{let l=n[oe],a=n[yi],v=n[yi][se],y=n[yi][he],p=n[iu],f=n[iu][ce],w=n[pi],b=n[pi][le],k=n[pi][ae],g=n[d],e=n[d][ve],nt=n[d][ye],o=n[d][pe],s=n[d][we],c=n[d].callback;var i=new ITEM.FeedbackController.FeedbackItem(l);if(w?i.SetStyleType(b,k):i.SetStyleType(undefined,undefined),i.SetType("task",u),a?i.SetDisplay(v,y):i.SetDisplay("time",2e4),p&&f.length>0)i.SetInteractionHighlight(f);else{const n=[];t.forEach(t=>{const i=t.id;n.push(i)});i.SetInteractionHighlight(n)}g?nt==!0?i.SetDismiss(o,s,e,su,c):i.SetDismiss(o,s,e,undefined,c):i.SetDismiss("auto","8000",undefined,!1,undefined);r("_feedbackArray - adding taskfeedback item:",i);h.AddFeedbackToArray(i)});t&&h&&t.forEach(n=>{let i=n[ci],t=n[wf];r("interactionFeedbackList",t);t&&t.forEach(n=>{let u=n[bf],l=n[kf],a=n[vi],v=n[vi][te],y=n[vi][ie],p=n[ai],w=n[ai][df],b=n[ai][gf],f=n[tu],k=n[tu][ne],d=n[nt],g=n[nt][ue],e=n[nt][fe],o=n[nt][ee],s=n[nt][re],c=n.dismiss.callback;var t=new ITEM.FeedbackController.FeedbackItem(l);u&&(t.id=u);a?t.SetStyleType(v,y):t.SetStyleType(undefined,undefined);t.SetType("interaction",i);p?t.SetDisplay(w,b):t.SetDisplay(undefined,undefined);f&&f.length>0?t.SetInteractionHighlight(k):t.SetInteractionHighlightAsArray(i);d?g==!0?t.SetDismiss(e,o,s,su,c):t.SetDismiss(e,o,s,undefined,c):t.SetDismiss("auto","8000",undefined,!1,undefined);r("_feedbackArray - adding interaction item:",t);h.AddFeedbackToArray(t)})})})}function eh(){t.debugMode&&(r("initDebug",i),sh(),hh(),oh())}function oh(){$("#debug--finish-exercise").on("click",wh)}function sh(){if(o){r("initDebugDisplays");let n=o.GetDebugMsgInput(ch,lh),t=o.GetDebugTaskTimer("00:00"),i=o.GetDebugTaskCount();$(ei).append(t);$(ei).append(i);$(ei).append(n)}}function hh(){if(o){let n=o?.GetHeaderBtn("bug_report",bo,{tooltip:"Debug Menu"}),t=o?.GetHeaderBtn("local_fire_department",ph,{tooltip:"Debug Sight"}),i=o?.GetHeaderBtn("image_aspect_ratio",yh,{tooltip:"Make Interaction Rectangles"}),r=o?.GetHeaderBtn("skip_next",ki,{tooltip:"Skip Task"});$(it).append(t);$(it).append(n);$(it).append(i);$(it).append(r)}}function ch(n){if($(n.target).val().length>0){let t=$(n.target).val();navigator.clipboard.writeText(t);r("copied to clipboard:",{copyValue:t});$(n.target).next().text(` --copied!`)}}function lh(n){ah(n)}function ah(n){let i=$(`${ar} .${yf}`),u=$(n.target).val(),f=u.replace(/(['"])?([a-z0-9A-Z_]+)(['"])?:/g,'"$2": '),r={};try{r=JSON.parse(f)}catch(e){vh(e,n)}let t=rh(r);t=wu(t);i.length>0&&i.css(t)}function vh(n){$(`#${lf} span`).text("Input JSON error.");r("JSON input error: ",{error:n})}function yh(){return $("body").toggleClass(vf),$(this).toggleClass(fi),i.isGeneratingRectanglesMode=!i.isGeneratingRectanglesMode,c(),w?.ToggleReportRectangle(i.isGeneratingRectanglesMode,null),!1}function ph(){return $("body").toggleClass(af),$(this).toggleClass(fi),!1}function wh(){i.didStart=!0;let n=Array.from($(ui));for(let t=0;t<n.length;t++)ki()}function r(n,i){t.debugMode&&console.log(n,i)}function er(n){r("handleObjectError()",{state:i,errorObject:n});bh(n)}function bh(n){r("exerciseShortCircuit()",{state:i,errorObject:n});dh(n);kh()}function kh(){$(uf).addClass(e)}function dh(n){let t;t=n?.errortype!=void 0?`Fejl: ${n.errortype}`:`Ukendt Fejl`;$(ff).text(t)}function gh(){return i.TaskObjectArray[i.currentTaskIndex]}function wu(n){let t=n;return Object.keys(t).forEach(n=>{typeof t[n]=="number"&&(t[n]=t[n]+"%")}),t}function nc(){let n=t.customCss;if(r("handleExerciseCustomCss, string",{customCssString:n,json:json,settings:t}),typeof n!="undefined"&&n){let r=document.createElement("style");r.type="text/css";r.innerHTML=n;$(t.contentWrapSelector).append(r);i.customCssSheet=r}}r("jsonData:",typeof n);const bu="#intro-begin",it=".exercise-header__tools-list",ku=".task-tool",or="#exerciseSettings",sr="#prevTask",rt="#pauseTask",ut="#playTask",ft="#enableAudio",et="#disableAudio",hr="#skipTask",ot="#enableSubtitles",st="#disableSubtitles",ht="#replayAudio",du="#restartExercise",l="hidden",gu="#debug-overlay",kt="#settings-overlay",cr="#results-overlay",dt="#unfocus-overlay",g="#audio-error-overlay",gt="#intro-overlay",nf="#result-attempt-list",ni="#confirm-restart-overlay",tf="#confirm-restart-btn",rf="#cancel-restart-btn",uf="#shortcircuit-overlay",ff="#shortcircuit-overlay-msg",ti="#mute-checkbox",ii="#subtitles-checkbox-settings",ri="#feedback-checkbox",ef="feedback-component",sf=".feedback-wrapper",a="#subtitles",hf="#subtitles-hide",lr="#subtitles-move",ui=".task",cf=".task:first",ar=".task.active:first",f=".active",s=t.exerciseSelector,tc=t.navigation.selector,vr="task",u="hidden",e="active-overlay",yr="active-subtitles",ct="active",pr="paused",fi="active",ei="#exercise-debug-container",lf="debug-msg",af="debug--sight",vf="debug--record-rect",yf="debug__mock-interaction",pf="debug__task-timer",wr="debug__task-count",oi="exerciseTaskModels",lt="id",si="audioFile",hi="delay",br="screenshot",kr="subtitles",k="interactionList",at="feedbackList",ci="id",dr="name",li="type",wf="feedbackList",gr="dimensions",nu="assessmentList",bf="id",kf="text",ai="display",df="type",gf="threshold",tu="highlight",ne="highlightInteraction",vi="feedbackType",te="mood",ie="size",nt="dismiss",re="text",ue="doItForMe",fe="type",ee="timeout",oe="text",yi="display",se="type",he="threshold",iu="highlight",ce="highlightInteraction",pi="feedbackType",le="mood",ae="size",d="dismiss",ve="text",ye="doItForMe",pe="type",we="timeout";let tt=0,wi,b;var v,w,y,h,bi,o,i={jsonData:n,currentTaskObject:{},currentTaskId:new String,currentTaskIndex:0,exerciseAttemptCount:0,InteractionArray:[],TaskObjectArray:[],EventLog:[],didStart:!1,isFinished:!1,isPaused:!1,isShowingSettings:!1,isShowingResults:!1,hideFeedback:!1,isMuted:!1,isSubtitled:!0,isGeneratingRectanglesMode:!1};return this.Start=ke,this.GetCurrentTaskObject=gh,de(),this};ITEM.AudioController=function(n){function t(t,i){n.debugMode&&console.log(t,i)}function i(){if(u()){t("PlayAudio (fileCheck FAILED)",audioControllerState);let r=audioControllerState.playAttemptCount,n=audioControllerState.audioObject.play();t("playAudio (start)",{audioObject:audioControllerState.audioObject,audioFile:audioControllerState.currentFile,attempts:r,promist:n});typeof n!="undefined"&&audioControllerState.currentFile!=""&&n.then(()=>{audioControllerState.playAttemptCount=0}).catch(u=>(audioControllerState.playAttemptCount<1?setTimeout(function(){t(`playAudio() : attempting to play audio at attempt #${r+1} `,n);i()},250):(t(`playAudio() : Could not play audiofile after ${r+1} attempts. Handling error:`,u),h(u)),audioControllerState.playAttemptCount>1?(f(),!1):void 0));audioControllerState.playAttemptCount++}}function e(){t("pauseAudio (audioPlayer.js)");audioControllerState.audioObject.pause()}function o(){t("replayAudio (audioPlayer.js)");audioControllerState.audioObject.currentTime=0;audioControllerState.audioObject.play()}function r(){t("stopAudio (audioPlayer.js)");audioControllerState.audioObject.currentTime=0;audioControllerState.audioObject.pause()}function s(n,i,r){audioControllerState.formerFile=audioControllerState.currentFile;audioControllerState.currentFile=n;audioControllerState.audioObject=new Audio(audioControllerState.currentFile);t("loadAudioFile",{audioObj:audioControllerState.audioObject,file:n,callback:i,duration:audioControllerState.audioObject.duration});audioControllerState.audioObject.addEventListener("play",function(){audioControllerState.isPlaying=!0;audioControllerState.isPaused=!1;r=="play"&&i()});audioControllerState.audioObject.addEventListener("pause",function(){audioControllerState.isPaused=!0;r=="pause"&&i()});audioControllerState.audioObject.addEventListener("ended",function(){audioControllerState.isPlaying=!1;audioControllerState.isPaused=!1;(r=="ended"||typeof r==undefined)&&i()})}function u(){return audioControllerState.currentFile!=""?!0:!1}function h(i){t("handleError (audio). Error:",{error:i,state:audioControllerState});switch(i.constructor){case DOMException:if(n.onDOMError!==undefined)n.onDOMError("Du skal lige interagere med din browser før vi må afspille lyden ...");else console.error(i);break;case SyntaxError:if(n.onDOMError!==undefined)n.onDOMError("Der er noget galt med lydfilen. Kontakt en kursusadminstrator.");else console.error(i);break;case Error:if(n.onDOMError!==undefined)n.onDOMError("Der er noget galt med lydfilen. Kontakt en kursusadminstrator.");else console.error(i);break;default:if(n.onDOMError!==undefined)n.onDOMError("Der er noget galt med lydfilen. Kontakt en kursusadminstrator.");else console.error(i)}}function f(){r();audioControllerState.formerFile=audioControllerState.currentFile;audioControllerState.currentFile="";audioControllerState.audioObject=new Audio(audioControllerState.currentFile)}function c(){audioControllerState.audioObject.volume=0}function l(){audioControllerState.audioObject.volume=1}function a(){return audioControllerState}function v(){return audioControllerState.audioObject}function y(){return typeof audioControllerState.audioObject!="undefined"&&audioControllerState.audioObject!=null?audioControllerState.audioObject.src==""?audioControllerState.audioObject.duration:!1:!1}return audioControllerState={audioObject:new Audio,isPlaying:!1,isPaused:!1,currentFile:"",formerFile:"",playAttemptCount:0},this.PlayAudio=i,this.ReplayAudio=o,this.StopAudio=r,this.PauseAudio=e,this.FileCheck=u,this.LoadAudioFile=s,this.ClearAudioFile=f,this.MuteAudio=c,this.UnmuteAudio=l,this.GetAudioFileDuration=y,this.GetAudioObject=v,this.GetAudioControllerState=a,this};ITEM.MarkupController=function(n,t){function gt(){}function ni(t){const i=t[vt],r=$(n.exerciseSelector);i.forEach(t=>{let i=[],u=t[wt],f=n.assetsPath+t[yt],e=t[pt];i.push(`
                <div class="${w}" id="${u}">
                <div class="${b}"></div>
